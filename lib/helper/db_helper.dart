...
class DBHelper{
  ...
  _createDatabase(Database db, int version) async {
    await db.execute(
      "CREATE TABLE mytodo(id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT NOT NULL, description TEXT NOT NULL, initialDate TEXT, endDate TEXT, startdate TEXT, enddate TEXT)",
    );
  }
